...
class _PokedexWidgetState extends State<PokedexWidget> {
  PokemonInfoStore _pokemonInfoStore = Modular.get<PokemonInfoStore>();
  ...
  Widget build(BuildContext context) {
    ...
    _pokemonInfoStore.listPokemons.add(_bulbasaur);
    _pokemonInfoStore.listPokemons.add(_ivysaur);
    _pokemonInfoStore.listPokemons.add(_venusaur);
    _pokemonInfoStore.listPokemons.add(_charmander);
  ...
  Widget pokemonCard({Pokemon? pokemon, int? index}) {
    return InkWell(
      onTap: () {
        print(pokemon?.name);
        _pokemonInfoStore.currentPokemon = pokemon!;
        Modular.to.pushNamed('/pokemonInfo/$index', arguments: pokemon);
      },
      child: Container(
        child: Stack(
          children: [
